...
int main(int argc, char* argv[])
{
 if (argc != 3)
  {
    printf("%s : expected 2 args, please enter two values\n", argv[0]);
    return 1;
  }
  ...
  if (found != 1)
    {
	printf("First arg is not a decimal, please enter two values\n");
	return 1;
    }
  ...
  if (found != 1)
    {
	printf("Second arg is not a decimal, please enter two values\n");
	return 1;
    }
